...
public class Program {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * NoticeDao proxy =
		 * (NoticeDao)Proxy.newProxyInstance(noticeDao.getClass
		 * ().getClassLoader(), noticeDao.getClass().getInterfaces(), new
		 * InvocationHandler() {
		 * 
		 * @Override public Object invoke(Object proxy, Method method, Object[]
		 * args) throws Throwable {
		 * 
		 * System.out.println("사전"); List<Notice> list =
		 * (List<Notice>)method.invoke(noticeDao, args);
		...
		ApplicationContext context = new ClassPathXmlApplicationContext(
				"com/newlecture/web/aop/spring_context.xml");
